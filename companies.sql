...
create table jobs(job_id varchar(20) primary key, job_title varchar(20), 
...
INSERT INTO
employees(employee_id,first_name,last_name,email,phone_number,hire_dat
e,job_id,salary,manager_id,department_id) VALUES (102,'Lex’,'De
Haan','lex.de haan@sgltutorial.org','515.123.4569','1993-01-
13',5,17000.00,100,9);
...
employees(employee_id,first_name,last_name,email,phone_number,hire_dat
e,job_id,salary,manager_id,department_id) VALUES
(104,'Bruce','Ernst’,'bruce.ernst@sgltutorial.org’,'590.423.4568','1991-05-
21',9,6000.00,103,6);
INSERT INTO
...
employees(employee_id, first _name,last_name,email,phone_number,hire_dat
e,job_id,salary,manager_id,department_id) VALUES
(111,'1smael’,'Sciarra’,'ismael.sciarra@sqltutorial.org','515.124.4369','1997-09-
30',6,7700.00,108,10);

INSERT INTO
employees(employee_id,first_name,last_name,email,phone_number,hire_dat
e,job_id,salary,manager_id,department_id) VALUES (112,'Jose
